...
export class InputHelper {
  ...
  static normalizePixKey(value: string, type: TPixKeyType): string {
    if (type === 'EVP' || type === 'EMAIL') return value
    ...
    if (type === 'PHONE') {
      ...
      return value.startsWith(defaultCountryCode) ? value : `${defaultCountryCode}${value}`
    }
